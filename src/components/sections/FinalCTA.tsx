...
export function FinalCTA() {
  return (
    <section className="py-24 px-4 bg-[#0a66c2] relative overflow-hidden border-y border-[#0057ab]">
      {/* Spotlight Effects */}
      <motion.div
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <motion.h2
          className="text-2xl md:text-3xl font-bold tracking-tight mb-3 leading-[1.1] text-white"
          initial={{ opacity: 0, y: -18 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={VP}
          transition={{ duration: 0.6, delay: 0.1 }}
        >
          Your next 1,000 LinkedIn followers{" "}
          <span className="animate-shimmer bg-gradient-to-r from-white via-[#a0c8ff] to-white bg-clip-text text-transparent">
            are closer than you think.
          </span>
        </motion.h2>

        <motion.p
          className="text-lg md:text-xl font-bold text-white mb-4 mt-3 mx-auto"
          initial={{ opacity: 0, y: -18 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={VP}
        ...
        >
          Join creators who stopped struggling to post consistently and started growing,
          spending less than 2 hours a week on LinkedIn.
        </motion.p>
